...
![Gráfica 1](./assets/img/grafica1.png)
...
![Gráfica 2](./assets/img/grafica2.png)
...
![Gráfica 3](./assets/img/grafica3.png)
...
![Gráfica 4](./assets/img/grafica4.png)
...
![Gráfica 6](./assets/img/grafica6.png)
...
### Amenazas según la UICN para las especies presentes en la zona

![Gráfica 13](./assets/img/grafica13.png)

## 🦦 Amenazas UICN para las especies presentes en el polígono
...
El nivel tres de amenazas que corresponde a impactos relacionados con la minería y la producción de energía...

<div style="margin-top:20px;">
  <a href="tabla_iucn.html" style="background:#2c7a7b; color:white; padding:10px 18px; text-decoration:none; border-radius:6px;">
